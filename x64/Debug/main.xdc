...
<member name="T:RunningSimulation" decl="false" source="X:\Saját\prog\BME\prog2\Nagyhazi\proba2\runsimulation.h" line="8">
<summary>
Class directly for running an already existing simulation
</summary>
</member>
<member name="M:RunningSimulation.userInput(sf.Event*!System.Runtime.CompilerServices.IsImplicitlyDereferenced)" decl="true" source="X:\Saját\prog\BME\prog2\Nagyhazi\proba2\runsimulation.h" line="23">
<summary>
Handles the user input during the visual simulation
</summary>
<param name="event">current SF event</param>
</member>
<member name="M:RunningSimulation.resetAttributes" decl="false" source="X:\Saját\prog\BME\prog2\Nagyhazi\proba2\runsimulation.h" line="29">
<summary>
Resets most static data member to its starting state
</summary>
</member>
<member name="M:RunningSimulation.#ctor" decl="true" source="X:\Saját\prog\BME\prog2\Nagyhazi\proba2\runsimulation.h" line="37">
NOT USED IN PRACTICE
</member>
<member name="M:RunningSimulation.saveMode" decl="false" source="X:\Saját\prog\BME\prog2\Nagyhazi\proba2\runsimulation.h" line="40">
<summary>
Returns what the current mode is: saving or no saving
</summary>
</member>
<member name="M:RunningSimulation.saveMode(System.Boolean)" decl="false" source="X:\Saját\prog\BME\prog2\Nagyhazi\proba2\runsimulation.h" line="45">
<summary>
Sets whether the simulation should save
</summary>
</member>
<member name="M:RunningSimulation.maxIteration(System.Int32)" decl="false" source="X:\Saját\prog\BME\prog2\Nagyhazi\proba2\runsimulation.h" line="50">
<summary>
Sets the limit of iterations
</summary>
</member>
<member name="M:RunningSimulation.setup(Simulation*,System.Boolean,System.Int32!System.Runtime.CompilerServices.IsLong)" decl="true" source="X:\Saját\prog\BME\prog2\Nagyhazi\proba2\runsimulation.h" line="55">
<summary>
Sets up the simulation to later run
</summary>
</member>
<member name="M:RunningSimulation.reachedMaxIt" decl="false" source="X:\Saját\prog\BME\prog2\Nagyhazi\proba2\runsimulation.h" line="60">
<summary>
Returns whether the simulation has reached maximum iterations
</summary>
</member>
<member name="M:RunningSimulation.getSimulation" decl="false" source="X:\Saját\prog\BME\prog2\Nagyhazi\proba2\runsimulation.h" line="65">
<summary>
Returns the pointer of the current simulation
</summary>
</member>
<member name="M:RunningSimulation.startNonVisual(System.Boolean)" decl="true" source="X:\Saját\prog\BME\prog2\Nagyhazi\proba2\runsimulation.h" line="70">
<summary>
Starts running the simulation, with no visuals, until it ends
</summary>
<returns>Returns the end state of the simulation</returns>
</member>
<member name="M:RunningSimulation.startVisual" decl="true" source="X:\Saját\prog\BME\prog2\Nagyhazi\proba2\runsimulation.h" line="77">
<summary>
Starts running the simulation with SFML, until it has ended
</summary>
<returns>Returns the end state of the simulation</returns>
</member>
<member name="M:RunningSimulation.changeSimulation(Simulation*,System.Boolean)" decl="false" source="X:\Saját\prog\BME\prog2\Nagyhazi\proba2\runsimulation.h" line="83">
<summary>
Changes the simulation associated with this class, resetting all its attributes
</summary>
<param name="newsim"></param>
</member>
<member name="M:RunningSimulation.newSystem(System.SByte!System.Runtime.CompilerServices.IsSignUnspecifiedByte!System.Runtime.CompilerServices.IsConst*)" decl="false" source="X:\Saját\prog\BME\prog2\Nagyhazi\proba2\runsimulation.h" line="94">
<summary>
Changes the simulation to simulate a new system from a new file
</summary>
<param name="filename">Name of file to be read from</param>
</member>
<member name="M:RunningSimulation.deleteSim" decl="false" source="X:\Saját\prog\BME\prog2\Nagyhazi\proba2\runsimulation.h" line="106">
<summary>
